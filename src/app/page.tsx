      ...
      <main className="flex-1 container mx-auto px-4 py-8 md:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          <Link href="/analise-texto" className="block group">
            <Card className="h-full border-2 hover:border-primary/50 transition-all duration-300 shadow-md hover:shadow-xl bg-card overflow-hidden flex flex-col">
              ...
              <CardHeader className="pt-8">
                ...
                <CardTitle className="text-2xl font-headline font-bold">Análise de Texto AI</CardTitle>
          ...
          <Link href="/analise-imagem" className="block group">
            <Card className="h-full border-2 hover:border-accent/50 transition-all duration-300 shadow-md hover:shadow-xl bg-card overflow-hidden flex flex-col">
              ...
              <CardHeader className="pt-8">
                ...
                <CardTitle className="text-2xl font-headline font-bold">Análise de Imagem AI</CardTitle>
                <CardDescription className="text-base">
        ...
        <section className="mt-20 py-12 border-t text-center">
          <h2 className="text-2xl font-headline font-bold mb-8">Por que usar o AnalisaPet AI?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-4 space-y-2">
              ...
              <h3 className="font-bold">Foco no Pet</h3>
